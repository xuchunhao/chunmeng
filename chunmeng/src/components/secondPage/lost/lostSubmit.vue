<template>
  <div class="lost-submit">
    <el-row type="flex" justify="center">
      <el-col :xs="24" :sm="24" :md="20" :lg="18" :xl="14" class="lost-submit-content-box">
        <h1>找到物品详情</h1>
        <div class="lost-submit-content">
          <div class="info-box">
            <label>简要说明:</label>
          ...
          <div>
            <el-button type="primary" @click="addLost">发布失物</el-button>
          </div>
        </div>
      </el-col>
    </el-row>
...
<style lang="sass">
  @import '@/assets/css/lostSubmit.scss'
</style>